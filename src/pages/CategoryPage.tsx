...
export default function CategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-[#2b394c]/5">
      <SEOHead routePath={`/blog/category/${category.slug}`} />
      <EnhancedHeader />
              ...
              <nav className="space-y-2">
                ...
                {categories.map(cat => (
                  <Link
                    ...
                    className={`block px-4 py-2 rounded-lg hover:bg-[#2b394c] hover:text-white transition-colors ${
                      cat.slug === categorySlug ? 'bg-[#2b394c] text-white' : 'text-gray-700'
                    }`}
                  >
                    {cat.name}
                  </Link>
