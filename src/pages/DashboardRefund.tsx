          ...
          <div className="flex-1 space-y-4 p-4 sm:p-6 lg:p-8 pt-6">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid gap-8">
                ...
                {/* Refund Eligibility */}
                <Card className={`${fancyCardClass} border-green-500/20 bg-green-50/50 dark:bg-green-950/20`}>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
                ...
                {/* Non-Refundable */}
                <Card className={`${fancyCardClass} border-red-500/20 bg-red-50/50 dark:bg-red-950/20`}>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
                ...
                {/* Contact */}
                <Card className={`${fancyCardClass} bg-gradient-to-br from-primary/5 to-accent/5`}>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
